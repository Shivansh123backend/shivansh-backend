...
export default function CallsPage() {
  ...
  const { data: calls, isLoading } = useListCalls({ campaignId: filterCampaign !== "__all__" ? parseInt(filterCampaign) : undefined });
  ...
  return (
    <Layout>
      <PageHeader title="Call Records" subtitle={`${(calls ?? []).length} total`} />
