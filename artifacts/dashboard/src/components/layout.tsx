...
const ADMIN_NAV = [
  ...
  { href: "/leads", label: "Lead Lists", icon: ListChecks },
  { href: "/lists", label: "Lists", icon: Layers },
  { href: "/bulk-upload", label: "Bulk Upload", icon: Upload },
  { href: "/agents", label: "AI Agents", icon: Bot },
  { href: "/human-agents", label: "Human Agents", icon: UserRound },
  ...
  { href: "/numbers", label: "DIDs", icon: Phone },
  { href: "/inbound-routes", label: "Inbound Routes", icon: ArrowDownToLine },
  { href: "/calls", label: "CDR", icon: PhoneCall },
  { href: "/send-sms", label: "Send SMS", icon: MessageSquare },
  { href: "/sms-logs", label: "SMS Logs", icon: MessageSquareText },
  { href: "/dnc", label: "DNC List", icon: ShieldX },
  { href: "/softphone", label: "Softphone", icon: Headphones },
  { href: "/callbacks", label: "Callbacks", icon: RotateCcw },
  { href: "/analytics", label: "Analytics", icon: BarChart2 },
  { href: "/ai-optimizer", label: "AI Optimizer", icon: Sparkles },
  { href: "/phone-qa", label: "Phone QA", icon: ClipboardCheck },
